                            ...
                            <div>
                                ...
                                <div className="relative group mt-1">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-10 pr-3 h-12 py-3 bg-[#eff6ff]/50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                            ...
                            <div>
                                ...
                                <div className="relative group mt-1">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="block w-full pl-10 pr-10 h-12 py-3 bg-[#eff6ff]/50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
