...
INSERT INTO forms (
    ...
    JSON_ARRAY(
        ...
        JSON_OBJECT('key', 'admission_date', 'label', 'Admission Date', 'type', 'date', 'required', false),
        JSON_OBJECT('key', 'roll_number', 'label', 'Roll Number', 'type', 'text', 'required', false),
        JSON_OBJECT('key', 'student_address', 'label', 'Student Address (D.no, Str name, Village, Mandal, Dist)', 'type', 'textarea', 'required', false),
