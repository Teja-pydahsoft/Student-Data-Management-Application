...
router.get('/report-for-students', attachUserScope, attendanceController.getAttendanceReportForStudents);
router.get('/report/abstract', attachUserScope, attendanceController.getAttendanceAbstract);
